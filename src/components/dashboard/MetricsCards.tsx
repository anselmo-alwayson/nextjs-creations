      ...
      {cards.map((card, i) => {
        ...
        return (
          <div
            ...
            className={`animate-fade-in-up stagger-${i + 1} min-w-[180px] flex-shrink-0 rounded-xl border ${card.borderClass} ${card.bgClass} p-4 shadow-sm transition-shadow hover:shadow-md cursor-pointer group relative`}
          >
